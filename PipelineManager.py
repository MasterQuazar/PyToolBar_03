...
class PipelineGuiApplication(PipelineApplication, PipelineShaderApplication):
	...
	def main_interface_function(self):
		...
		self.form = mc.formLayout(parent=self.main_column)
		self.tabs = mc.tabLayout(innerMarginWidth=5, innerMarginHeight=5)
		mc.formLayout(self.form, edit=True, attachForm=((self.tabs,"top",0), (self.tabs, "bottom",0),(self.tabs,"left",0),(self.tabs,"right",0)))
