...
#class PipelineGuiApplication():
	...
	def main_interface_function(self):
		...
		#self.main_window = mc.window(title="PipelineManager", sizeable=True, height=self.default_height, width=self.default_width)
		self.pack_function_list["Pipeline"] = ["PipelineManagerTool"]


		#self.main_column = mc.columnLayout(adjustableColumn=True)
		self.PipelineManagerTool = mc.frameLayout(visible=True, parent=self.main_column, label="PipelineManagerTool", labelAlign="top", width=self.window_width, collapsable=True, collapse=True)
		...
		self.asset_main_scroll = mc.scrollLayout(horizontalScrollBarThickness=1, width=self.default_width+16, parent=self.prod_column, resizeCommand=self.resize_command_function, height=self.default_height)
		...
		self.project_columns = mc.rowColumnLayout(numberOfColumns=3, parent=self.asset_main_scroll, columnWidth=((1, self.default_width/2)))
		...
		self.assets_search_frame = mc.frameLayout(label="Search for assets", parent=self.asset_main_scroll, collapsable=True, collapse=True, width=self.default_width)
		self.prod_scroll = mc.scrollLayout(horizontalScrollBarThickness=16, parent=self.assets_search_frame,height=self.default_height/2)	
		self.prod_columns = mc.rowColumnLayout(numberOfColumns=5 , columnWidth=((1, self.default_width/5), (2, self.default_width/5),(3, self.default_width/5), (4, self.default_width/5)),parent=self.prod_scroll)
		...
		self.type_list = mc.textScrollList(allowMultiSelection=True, parent=self.prod_columns, height=self.default_height/2, selectCommand=self.display_new_list_function, append=self.type_list_value)
		self.name_list = mc.textScrollList(allowMultiSelection=True, parent=self.prod_columns, height=self.default_height/2, selectCommand=self.display_new_list_function)
		self.kind_list = mc.textScrollList(allowMultiSelection=True, parent=self.prod_columns, height=self.default_height/2, selectCommand=self.display_new_list_function)
		self.result_list = mc.textScrollList(allowMultiSelection=True, parent=self.prod_columns, height=self.default_height/2)
		...
		self.import_rowcolumn = mc.rowColumnLayout(parent=self.assets_search_frame, numberOfColumns=2, columnAlign=((1, "left"), (2, "right")), columnWidth=((1, self.default_width/2), (2, self.default_width/2)))
		...
		self.texture_search_frame = mc.frameLayout(label="Search for textures", width=self.default_width, parent=self.asset_main_scroll, collapsable=True, collapse=False)
		self.texture_scroll_layout = mc.scrollLayout(horizontalScrollBarThickness=16, parent=self.texture_search_frame, height=1)	

		#texture path field
		self.texture_path_row_columns = mc.rowColumnLayout(numberOfColumns=2, parent=self.texture_search_frame, columnWidth=((1, self.default_width/2), (2, self.default_width/2)))
		...
		self.texture_columns = mc.rowColumnLayout(parent=self.texture_search_frame, numberOfColumns=3, width=self.default_width, columnWidth=((1, self.default_width/3), (2, self.default_width/3), (3, self.default_width/3)))
		...
		self.texture_channel_list = mc.textScrollList(allowMultiSelection=False, parent=self.texture_columns, height=self.default_height/2, selectCommand=partial(self.refresh_textures_list_function, "channel"))
		self.texture_name_list = mc.textScrollList(allowMultiSelection=True, parent=self.texture_columns, height=self.default_height/2, selectCommand=partial(self.refresh_textures_list_function, "name"))
		self.texture_found_list = mc.textScrollList(allowMultiSelection=False, parent=self.texture_columns, height=self.default_height/2, selectCommand=self.select_texture_function)

		self.texture_shader_connexion_column = mc.rowColumnLayout(numberOfColumns=2, parent=self.texture_search_frame, columnWidth=((1, self.default_width/2), (2, self.default_width/2)))
		mc.button(label="Create Shader", parent=self.texture_shader_connexion_column, command=self.create_shader_function)
		...
		self.export_scroll = mc.scrollLayout(horizontalScrollBarThickness=16, parent=self.export_column, height=self.default_height, resizeCommand=self.resize_command_function)
		self.export_frame = mc.frameLayout(label="Save new edit file", width=self.default_width, parent=self.export_scroll, collapse=True, collapsable=True)
		"""
		save a new scene
		publish the scene
			version
		...
		"""
		self.export_save_rowcolumn = mc.rowColumnLayout(numberOfColumns=5, parent=self.export_frame, columnWidth=((1, self.default_width/5), (2, self.default_width/5),(3, self.default_width/5),(4, self.default_width/5), (5,self.default_width/5)))
		...
		self.export_version_rowcolumn = mc.rowColumnLayout(numberOfColumns=2, parent=self.export_save_rowcolumn, columnWidth=((1, self.default_width/20), (2, self.default_width/5)))
		...
		self.export_shot_version_rowcolumn = mc.rowColumnLayout(numberOfColumns=2, parent=self.export_frame, columnWidth=((1, self.default_width/2), (2, self.default_width/2)))
		...
		self.final_export_rowcolumn = mc.rowColumnLayout(numberOfColumns=3, parent=self.export_frame, columnWidth=((1, self.default_width/3), (2, self.default_width/3), (3, self.default_width/3)))
		...
		self.settings_main_scroll = mc.scrollLayout(horizontalScrollBarThickness=1, parent=self.settings_column, resizeCommand=self.resize_command_function, width=self.default_width,height=self.default_height)

		self.settings_file_frame = mc.frameLayout(label="Files settings", parent=self.settings_main_scroll, width=self.default_width, collapsable=True, collapse=True)
		self.settings_file_scroll = mc.scrollLayout(horizontalScrollBarThickness=16, parent=self.settings_file_frame, height=self.default_height/2)
		self.setting_rowcolumn1 = mc.rowColumnLayout(numberOfColumns=4, parent=self.settings_file_scroll, columnWidth=((1, self.default_width/6), (2, self.default_width/6), (3, self.default_width/6), (4, self.default_width/2)))
		...
		self.setting_rowcolumn2 = mc.rowColumnLayout(numberOfColumns=2, columnWidth=((1, self.default_width/2), (2, self.default_width/2)), parent=self.settings_file_scroll)
		...
		self.setting_rowcolumn2button = mc.rowColumnLayout(numberOfColumns=3, parent=self.settings_file_scroll, columnWidth=((1, self.default_width/3), (2, self.default_width/3), (3, self.default_width/3)))
		...
		self.setting_rowcolumn3 = mc.rowColumnLayout(numberOfColumns=3, parent=self.settings_file_scroll, width=self.default_width, columnWidth=((1, self.default_width/2-10), (2, self.default_width/4-10), (3, self.default_width/4-10)))
		...
		self.settings_texture_frame = mc.frameLayout(label="Texture settings", parent=self.settings_main_scroll, width=self.default_width, collapsable=True, collapse=False)
		"""
		...
		self.settings_channel_editor_frame = mc.frameLayout(label="Channel Editor", parent=self.settings_texture_frame, width=self.default_width, collapsable=True, collapse=True)
		"""
		CREATE CHANNEL
			informations needed:
				name of the channel
		...
		"""
		self.channel_editor_rowcolumnlayout = mc.rowColumnLayout(numberOfColumns=2, parent=self.settings_channel_editor_frame, columnWidth=((1, self.default_width/2), (2, self.default_width/2)))
		...
		self.settings_keyword_editor_frame = mc.frameLayout(label="Keyword Editor", parent=self.settings_texture_frame, width=self.default_width, collapsable=True, collapse=True)
		...
		self.shading_settings_rowcolumn1 = mc.rowColumnLayout(numberOfColumns=2, parent=self.settings_texture_frame, columnWidth=((1, self.default_width/4), (2, int(self.default_width - self.default_width/4))))

		mc.text(label="Channel List", parent=self.shading_settings_rowcolumn1)
		mc.text(label="", parent=self.shading_settings_rowcolumn1)

		self.channel_textscrolllist = mc.textScrollList(height=self.default_height,allowMultiSelection=False,parent=self.shading_settings_rowcolumn1, selectCommand=partial(self.refresh_shading_settings_list_function, "channel"))
		...
		self.shading_settings_rowcolumn2 = mc.rowColumnLayout(numberOfColumns=3, parent=self.shading_settings_right_column, columnWidth=((1, self.default_width/4), (2, self.default_width/4), (3, self.default_width/4)))
		...
		self.shading_settings_rowcolumn3 = mc.rowColumnLayout(numberOfColumns=3, parent=self.shading_settings_right_column, columnWidth=((1, self.default_width/4), (2, self.default_width/4), (3, self.default_width/4)))
		...
		self.shading_settings_rowcolumn4 = mc.rowColumnLayout(numberOfColumns=2, parent=self.shading_settings_right_column, columnWidth=((1, int((self.default_width-self.default_width/4)/2)), (2, int((self.default_width-self.default_width/4)/2))))
		...
		self.log_column = mc.columnLayout(adjustableColumn=True, parent=self.tabs, height=self.default_height)
		self.log_scroll = mc.scrollLayout(horizontalScrollBarThickness=16, parent=self.log_column, height=self.default_height, resizeCommand=self.resize_command_function)

		self.log_program_frame = mc.frameLayout(label="Program Log", labelAlign="top", width=self.default_width, collapsable=True, collapse=True,parent=self.log_scroll)
		self.log_list = mc.textScrollList(parent=self.log_program_frame, allowMultiSelection=False, enable=True, height=self.default_height/2, append=self.log_list_content)

		self.log_team_frame = mc.frameLayout(label="Team logs", width=self.default_width, collapsable=True, collapse=True, parent=self.log_scroll)
		self.lost_team_list = mc.textScrollList(parent=self.log_team_frame, allowMultiSelection=False, enable=True, height=self.default_height/2)
